                ...
                <div class="card shadow p-4">
                    ...
                    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="number" value="{{ old('price',$product->price) }}" class="@error('price') is-invalid @enderror
                        ...
                        <div class="mb-2">
                            ...
                            <textarea class="form-control" value="{{ old('description',$product->description) }}" name="description"
                                rows="3"></textarea>
                                  @error('desciption')
                                <p class="inviled-feedback">{{ $message }}</p>
                            @enderror
